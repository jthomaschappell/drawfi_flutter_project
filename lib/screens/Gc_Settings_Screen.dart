...
class GcSettingsScreen extends StatelessWidget {
          ...
          child: ListTile(
            ...
            leading: Container(
              ...
              child: Icon(
                icon,
                color:
                    isDestructive ? Colors.red[700] : const Color(0xFF6500E9),
                size: 24,
              ),
            ),
            title: Text(
  ...
  Widget build(BuildContext context) {
    ...
    final userRole =
        (userProfile['user_role'] as String? ?? 'USER').toUpperCase();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon:
              const Icon(Icons.arrow_back, color: Color(0xFF1A1A1A), size: 24),
          onPressed: () => Navigator.pop(context),
        ),
      ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Settings Sections
                /// TODO:
                /// This part is overflowing by 32 pixels at regular resolution.
                /// How can I fix it?
                Padding(
